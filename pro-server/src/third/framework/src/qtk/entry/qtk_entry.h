...
qtk_entry_t *qtk_entry_new(qtk_entry_cfg_t *cfg, struct qtk_fwd *frame, qtk_log_t *log);
...
struct qtk_socket_server* qtk_entry_get_worker(qtk_entry_t *entry, int idx);
