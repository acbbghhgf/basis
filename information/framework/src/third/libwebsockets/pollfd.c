...
_lws_change_pollfd(struct lws *wsi, int _and, int _or, struct lws_pollargs *pa)
{
    ...
    if (_or & LWS_POLLOUT) {
        ...
        lws_libqev_io(wsi, LWS_EV_START | LWS_EV_WRITE);
    }
