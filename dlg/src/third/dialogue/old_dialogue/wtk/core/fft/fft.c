...
void wtk_cdft(int n, int isgn, float *a)
{
    void  wtk_cftfsub(int n, float *a);
    void  wtk_cftbsub(int n, float *a);
...
void  wtk_rdft(int n, int isgn, float *a)
{
    void  wtk_cftfsub(int n, float *a);
    void  wtk_cftbsub(int n, float *a);
    void  wtk_rftfsub(int n, float *a);
    void  wtk_rftbsub(int n, float *a);
    float xi;
...
void  wtk_ddct(int n, int isgn, float *a)
{
    void  wtk_cftfsub(int n, float *a);
    void  wtk_cftbsub(int n, float *a);
    void  wtk_rftfsub(int n, float *a);
    void  wtk_rftbsub(int n, float *a);
    void  wtk_dctsub(int n, float *a);
    void  wtk_dctsub4(int n, float *a);
    int j;
    float xr;
...
void  wtk_ddst(int n, int isgn, float *a)
{
    void  wtk_cftfsub(int n, float *a);
    void  wtk_cftbsub(int n, float *a);
    void  wtk_rftfsub(int n, float *a);
    void  wtk_rftbsub(int n, float *a);
    void  wtk_dstsub(int n, float *a);
    void  wtk_dstsub4(int n, float *a);
    int j;
    float xr;
...
void  wtk_dfct(int n, float *a)
{
    void  wtk_ddct(int n, int isgn, float *a);
    void  wtk_bitrv1(int n, float *a);
    int j, k, m, mh;
...
void  wtk_cftfsub(int n, float *a)
{
    void  wtk_bitrv2(int n, float *a);
    void  wtk_bitrv216(float *a);
    void  wtk_bitrv208(float *a);
    void  wtk_cftmdl1(int n, float *a);
    void  wtk_cftrec4(int n, float *a);
    void  wtk_cftleaf(int n, int isplt, float *a);
    void  wtk_cftfx41(int n, float *a);
    void  wtk_cftf161(float *a);
    void  wtk_cftf081(float *a);
    void  wtk_cftf040(float *a);
    void  wtk_cftx020(float *a);
...
void  wtk_cftbsub(int n, float *a)
{
    void  wtk_bitrv2conj(int n, float *a);
    void  wtk_bitrv216neg(float *a);
    void  wtk_bitrv208neg(float *a);
    void  wtk_cftb1st(int n, float *a);
    void  wtk_cftrec4(int n, float *a);
    void  wtk_cftleaf(int n, int isplt, float *a);
    void  wtk_cftfx41(int n, float *a);
    void  wtk_cftf161(float *a);
    void  wtk_cftf081(float *a);
    void  wtk_cftb040(float *a);
    void  wtk_cftx020(float *a);
#ifdef USE_CDFT_THREADS
    void cftrec4_th(int n, float *a);
#endif /* USE_CDFT_THREADS */
...
void  wtk_cftrec4(int n, float *a)
{
    int  wtk_cfttree(int n, int j, int k, float *a);
    void  wtk_cftleaf(int n, int isplt, float *a);
    void  wtk_cftmdl1(int n, float *a);
    int isplt, j, k, m;
    ...
    wtk_cftleaf(m, 1, &a[n - m]);
    k = 0;
    for (j = n - m; j > 0; j -= m) {
        k++;
        isplt =  wtk_cfttree(m, j, k, a);
        wtk_cftleaf(m, isplt, &a[j - m]);
    }
}
...
{
    void  wtk_cftmdl1(int n, float *a);
    void  wtk_cftmdl2(int n, float *a);
    int i, isplt, m;
...
void  wtk_cftleaf(int n, int isplt, float *a)
{
    ...
    void  wtk_cftmdl2(int n, float *a);
    void  wtk_cftf161(float *a);
    void  wtk_cftf162(float *a);
    void  wtk_cftf081(float *a);
    void  wtk_cftf082(float *a);
    ...
    if (n == 512) {
    	 ...
    	 wtk_cftf161(&a[64]);
    	 wtk_cftf161(&a[96]);
    	 wtk_cftmdl2(128, &a[128]);
    	 wtk_cftf161(&a[128]);
    	 wtk_cftf162(&a[160]);
    	 wtk_cftf161(&a[192]);
    	 wtk_cftf162(&a[224]);
    	 wtk_cftmdl1(128, &a[256]);
    	 wtk_cftf161(&a[256]);
    	 wtk_cftf162(&a[288]);
    	 wtk_cftf161(&a[320]);
    	 wtk_cftf161(&a[352]);
        if (isplt != 0) {
        	 wtk_cftmdl1(128, &a[384]);
        	 wtk_cftf161(&a[480]);
        } else {
        	 wtk_cftmdl2(128, &a[384]);
        	 wtk_cftf162(&a[480]);
        }
        wtk_cftf161(&a[384]);
        wtk_cftf162(&a[416]);
        wtk_cftf161(&a[448]);
    	 ...
    	 wtk_cftf081(&a[96]);
    	 wtk_cftf082(&a[112]);
    	 wtk_cftmdl1(64, &a[128]);
    	 wtk_cftf081(&a[128]);
    	 wtk_cftf082(&a[144]);
    	 wtk_cftf081(&a[160]);
    	 wtk_cftf081(&a[176]);
        if (isplt != 0) {
        	 wtk_cftmdl1(64, &a[192]);
        	 wtk_cftf081(&a[240]);
        } else {
        	 wtk_cftmdl2(64, &a[192]);
        	 wtk_cftf082(&a[240]);
        }
        wtk_cftf081(&a[192]);
        wtk_cftf082(&a[208]);
